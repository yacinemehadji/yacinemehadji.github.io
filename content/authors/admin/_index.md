...
* position: "Ingénieur de Recherche en Nanotechnologie"
...
* position: "Ingénieur d'Études en Microélectronique"
...
* position: "Ingénieur de Recherche en Électronique"
...
* name: "Microélectronique et IC Design"
  ...
  * name: "Cadence Virtuoso"
    description: "Conception et simulation de circuits intégrés"
    percent: 85
    icon: "cpu-chip"
  ...
  * name: "Packaging"
    description: "Wire bonding, flip-chip et assemblage PCB"
    percent: 85
    icon: "cube"
...
Mon parcours combine conception de circuits intégrés, layout, vérification physique, packaging électronique, FPGA, systèmes embarqués et intelligence artificielle.

Je m'intéresse particulièrement aux technologies CMOS et Beyond CMOS, à la spintronique et au calcul neuromorphique, ainsi qu'aux applications du Deep Learning dans les domaines scientifiques et médicaux.
...
Je développe également des projets en intelligence artificielle et Deep Learning, notamment pour l'analyse d'images médicales avec Python, TensorFlow, Keras, OpenCV et Streamlit.
